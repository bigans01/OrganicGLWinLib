...
CyclingDirectionFinder::CyclingDirectionFinder(SPolyBorderLines in_borderLineCopy, CategorizedLine in_categorizedLineCopy)
{
	...
	quatPoints.insertPointRefs(&borderLine.pointA, &borderLine.pointB, &categorizedLine.line.pointA, &categorizedLine.line.pointB);
	...
	*/
	...
	quatPoints.insertPointRefs(&categorizedLine.emptyNormal);
