...
CyclingDirectionFinder::CyclingDirectionFinder(SPolyBorderLines in_borderLineCopy, CategorizedLine in_categorizedLineCopy, MassManipulationMode in_massManipulationMode)
{
	...
	quatPoints.pointsRefVector.push_back(&borderLine.pointA);
	quatPoints.pointsRefVector.push_back(&borderLine.pointB);
	quatPoints.pointsRefVector.push_back(&categorizedLine.line.pointA);
	quatPoints.pointsRefVector.push_back(&categorizedLine.line.pointB);
	...
	quatPoints.pointsRefVector.push_back(&categorizedLine.emptyNormal);
