...
class TwoDLineSegmentIntersectAnalyzerV2
{
	public:	
		...
		void setColinearQMDebugLevel(PolyDebugLevel in_debugLevel);
		void setIntersectionQMDebugLevel(PolyDebugLevel in_debugLevel);
	...
	private:
		...
		PolyDebugLevel colinearQMDebugLevel = PolyDebugLevel::NONE;
		PolyDebugLevel intersectingQMDebugLevel = PolyDebugLevel::NONE;
