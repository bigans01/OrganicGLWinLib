...
class QMVec3FindCyclingDirectionPoint : public QMVec3ResultBase
{
	public:
		Vec3Result solve(QuatRotationPoints* in_quatRotationPointsRef, PolyDebugLevel in_polyDebugLevel);
	private:
