...
class PTriangle
{
	public:
		PTriangle() {};
		PTriangle(RCollisionPoint* in_candidatePoint0Ref, RCollisionPoint* in_candidatePoint1Ref, RCollisionPoint* in_candidatePoint2Ref, glm::vec3 in_targetEmptyNormal)
		{
			...
			bool didTestPass = runInitialEmptyNormalTest();
