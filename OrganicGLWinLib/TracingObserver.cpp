...
void TracingObserver::setObservationLogLevel(PolyDebugLevel in_polyDebugLevel)
{
	tracingObserverLogger.setDebugLevel(in_polyDebugLevel);
}
...
bool TracingObserver::insertWeldedTriangleIfLineOfSightIsMaintained()
{
