...
void RAdditiveXSliceStandalone::buildInitialPointSets()
{
...
void RAdditiveXSliceStandalone::runInitialPointAdjustments()
{

}

void RAdditiveXSliceStandalone::buildPointSets()
{
...
void RAdditiveXSliceStandalone::generateSetARCollisionPoints(int in_numberOfPointsBetweenCorners,
	glm::vec3 in_corner0,
	glm::vec3 in_corner1,
	glm::vec3 in_corner2,
	glm::vec3 in_corner3)
...
void RAdditiveXSliceStandalone::generateSetBRCollisionPoints(int in_numberOfPointsBetweenCorners,
	glm::vec3 in_corner0,
	glm::vec3 in_corner1,
	glm::vec3 in_corner2,
	glm::vec3 in_corner3)
...
void RAdditiveXSliceStandalone::buildPTriangles(bool in_buildDebugFlag)
{
